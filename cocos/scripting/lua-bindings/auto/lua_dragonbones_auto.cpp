...
int lua_dragonbones_Armature_replaceSlot(lua_State* tolua_S)
{
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_object<dragonBones::Slot>(tolua_S, 4, "db.Slot",&arg2, "db.Armature:replaceSlot");
        if(!ok)
        {
...
int lua_dragonbones_BaseFactory_addTextureAtlas(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<dragonBones::ITextureAtlas>(tolua_S, 2, "db.ITextureAtlas",&arg0, "db.BaseFactory:addTextureAtlas");
        if(!ok)
        {
...
int lua_dragonbones_BaseFactory_getTextureDisplay(lua_State* tolua_S)
{
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_object<const dragonBones::DisplayData>(tolua_S, 4, "db.DisplayData",&arg2, "db.BaseFactory:getTextureDisplay");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_dragonbones_BaseFactory_getTextureDisplay'", nullptr);
            return 0;
...
int lua_dragonbones_DBCCSlot_setDisplayImage(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<cocos2d::Node>(tolua_S, 2, "cc.Node",&arg0, "db.DBCCSlot:setDisplayImage");
        if(!ok)
        {
...
int lua_dragonbones_DBCCSlot_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<dragonBones::SlotData>(tolua_S, 2, "db.SlotData",&arg0, "db.DBCCSlot:DBCCSlot");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmature_setArmatureNode(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<dragonBones::DBCCArmatureNode>(tolua_S, 2, "db.DBCCArmatureNode",&arg0, "db.DBCCArmature:setArmatureNode");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmature_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 4) 
    {
        ...
        ok &= luaval_to_object<dragonBones::ArmatureData>(tolua_S, 2, "db.ArmatureData",&arg0, "db.DBCCArmature:DBCCArmature");

        ok &= luaval_to_object<dragonBones::Animation>(tolua_S, 3, "db.Animation",&arg1, "db.DBCCArmature:DBCCArmature");

        ok &= luaval_to_object<dragonBones::IEventDispatcher>(tolua_S, 4, "db.IEventDispatcher",&arg2, "db.DBCCArmature:DBCCArmature");

        ok &= luaval_to_object<cocos2d::Node>(tolua_S, 5, "cc.Node",&arg3, "db.DBCCArmature:DBCCArmature");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmatureNode_initWithDBCCArmature(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<dragonBones::DBCCArmature>(tolua_S, 2, "db.DBCCArmature",&arg0, "db.DBCCArmatureNode:initWithDBCCArmature");

        ok &= luaval_to_object<dragonBones::WorldClock>(tolua_S, 3, "db.WorldClock",&arg1, "db.DBCCArmatureNode:initWithDBCCArmature");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmatureNode_create(lua_State* tolua_S)
{
    ...
    {
        dragonBones::DBCCArmature* arg0;
        ok &= luaval_to_object<dragonBones::DBCCArmature>(tolua_S, 2, "db.DBCCArmature",&arg0, "db.DBCCArmatureNode:create");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmatureNode_createWithWorldClock(lua_State* tolua_S)
{
    ...
    if (argc == 2)
    {
        dragonBones::DBCCArmature* arg0;
        dragonBones::WorldClock* arg1;
        ok &= luaval_to_object<dragonBones::DBCCArmature>(tolua_S, 2, "db.DBCCArmature",&arg0, "db.DBCCArmatureNode:createWithWorldClock");
        ok &= luaval_to_object<dragonBones::WorldClock>(tolua_S, 3, "db.WorldClock",&arg1, "db.DBCCArmatureNode:createWithWorldClock");
        if(!ok)
        {
