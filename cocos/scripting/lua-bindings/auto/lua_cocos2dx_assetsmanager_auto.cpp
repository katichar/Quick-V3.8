...
int lua_cocos2dx_assetsmanager_EventAssetsManagerEx_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 3) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_assetsmanager_EventAssetsManagerEx_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_assetsmanager_EventAssetsManagerEx_constructor'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_assetsmanager_EventAssetsManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EventAssetsManagerEx");
        tolua_function(tolua_S,"new",lua_cocos2dx_assetsmanager_EventAssetsManagerEx_constructor);
...
int lua_cocos2dx_assetsmanager_Manifest_getSearchPaths(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::Manifest* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_assetsmanager_Manifest_getSearchPaths'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_assetsmanager_Manifest_getSearchPaths'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_assetsmanager_Manifest_getSearchPaths'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_assetsmanager_Manifest(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Manifest");
        ...
        tolua_function(tolua_S,"getSearchPaths",lua_cocos2dx_assetsmanager_Manifest_getSearchPaths);
    tolua_endmodule(tolua_S);
...
int lua_cocos2dx_assetsmanager_AssetsManagerEx_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 2) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_assetsmanager_AssetsManagerEx_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_assetsmanager_AssetsManagerEx_constructor'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_assetsmanager_AssetsManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"AssetsManagerEx");
        tolua_function(tolua_S,"new",lua_cocos2dx_assetsmanager_AssetsManagerEx_constructor);
...
int lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_init(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_init'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EventListenerAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_constructor'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_assetsmanager_EventListenerAssetsManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EventListenerAssetsManagerEx");
        tolua_function(tolua_S,"new",lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_assetsmanager_EventListenerAssetsManagerEx_init);
    tolua_endmodule(tolua_S);
